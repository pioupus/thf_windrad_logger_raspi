...
_DATASET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_git_hash', full_name='enerlyzer.dataset.current_git_hash', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='raspberry_uptime_s', full_name='enerlyzer.dataset.raspberry_uptime_s', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='service_uptime_s', full_name='enerlyzer.dataset.service_uptime_s', index=42,
